...
public class C17Collect {
	public static void main(String[] args) {
		...
		Map<String, Integer> r2 = list.stream()
				.collect(Collectors.groupingBy(Car::getType, Collectors.summingInt(Car::getPrice))); //타입별로 가격 합산
		
		r2.entrySet().stream().forEach(e -> System.out.println(e.getKey() + ":" + e.getValue()));
